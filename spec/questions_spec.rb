...
describe 'Ninety-Nine Bottles' do

  it 'can return 99 bottles of beer on the wall' do
    expect(first_line(99)).to eq "99 bottles of beer on the wall, 99 bottles of beer.\n"
  end

  it 'can return 2 bottles of beer on the wall' do
    expect(first_line(2)).to eq "2 bottles of beer on the wall, 2 bottles of beer.\n"
  end

  it 'can return 1 bottle of beer' do
    expect(first_line(1)).to eq "1 bottle of beer on the wall, 1 bottle of beer.\n"
  end

  it 'can return No more bottles of beer' do
    expect(first_line(0)).to eq "No more bottles of beer on the wall, No more bottles of beer.\n"
  end
end
